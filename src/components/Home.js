  ...
  return (
    <>
      <div className="flex flex-wrap bg-navdark-200 text-white pb-14">
        ...
        <img
          className="h-[30%] lg:ml-72 lg:mt-36 m-[auto] p-8 lg:p-0"
          src={headImage}
        />
      </div>
      ...
      <div className="flex flex-wrap lg:pb-32 bg-gray-200 justify-between gap-10 lg:gap-36">
        <div className="mt-10 text-center xl:text-left mx-[auto] lg:mx- xl:mx-72 sm:mx-10 md:px-56 lg:ml-[35%] xl:ml-40  lg:px-0">
        ...
        <div>
          <h2 className="font-medium text-center xl:text-left text-3xl m-10 lg:mx-52 xl:m-10 max-w-[840px] xl:mt-28 x:mr-48">
            "The best agency we’ve worked with so far. They understand our
            product and are able to add new features with a great focus."
          </h2>
          <div className="flex md:mx-20 xl:ml-0 justify-center lg:justify-start lg:ml-[38%] mt-10 mb-10 lg:mb-0">
            <img
              src={vp}
              alt="Woman"
            ...
            <div className="md:ml-10 lg:ml-6">
              ...
              <p className="flex text-xs font-medium">Vice President</p>
            </div>
          </div>
        </div>
      </div>
